...
import BusinessmanSection from '../components/sections/BusinessmanSection';
  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        <BusinessmanSection articles={data.articles} />
        
        <ThreeColumnSection articles={data.articles} />
      </main>
