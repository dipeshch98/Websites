...
const ArticlePage = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Main Content */}
      <div className="max-w-[1300px] mx-auto px-4 md:px-6 lg:px-6 py-12 pt-24 flex flex-col gap-10">
        {/* Article Header */}
        <div className="space-y-4">
          {currentArticle.category && (
            <span className="inline-block bg-[#00c003] text-white text-xs font-semibold px-3 py-1 rounded-full uppercase mb-2">
              ...
              {relatedPosts.map((post) => (
                ...
                >
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <h3 className="text-gray-900 font-bold text-base leading-snug line-clamp-2 group-hover:text-[#00c003] transition-colors duration-300">
                      {post.title}
                    </h3>
