  ...
  return (
    <section className="w-full bg-gray-50 py-16">
      <div className="max-w-[1300px] mx-auto px-4 md:px-6 lg:px-6">
        {/* Section Title */}
        <h2 className="text-3xl font-extrabold text-gray-900 border-l-4 border-[#00c003] pl-3 mb-10">
          ...
          >
            ...
            <div className="p-5 space-y-2">
              {firstArticle.category && (
                <span className="inline-block bg-[#00c003] text-white text-xs font-semibold px-3 py-1 rounded-full uppercase">
                  {firstArticle.category}
                </span>
              )}
              <h3 className="text-lg font-bold text-gray-900 line-clamp-2 group-hover:text-[#00c003] transition-colors">
                {firstArticle.title}
              </h3>
