...
const ArticlePage = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-6 py-12 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-10 pt-24">
        {/* Left Column */}
        <main className="flex flex-col gap-6">
          {/* Article Header */}
          <div className="space-y-4">
            {currentArticle.category && (
              <span className="text-xs text-white border-b-emerald-500 rounded-sm p-1 bg-blue-600 font-semibold uppercase">
...
{relatedPosts.length > 0 && (
  <div className="max-w-full mx-auto pt-12">
    <h2 className="text-2xl font-bold text-gray-900 border-l-4 border-blue-600 pl-3 mb-6">
      You May Like
    </h2>
      ...
      {relatedPosts.slice(0, 4).map((post) => (
        ...
        >
          ...
          <div className="p-4 space-y-2">
            ...
            {/* Title: allow wrapping, truncate with ... only if 3 lines */}
            <h3 className="text-gray-900 font-bold text-base leading-snug break-words line-clamp-3 group-hover:text-blue-600 transition-colors duration-300 py-2">
              {post.title}
            </h3>
        ...
        <aside className="flex flex-col gap-6 lg:sticky lg:top-24 self-start">
          <h2 className="text-2xl font-bold text-gray-900 border-l-4 border-blue-600 pl-3 mb-4">
            Must Read
          </h2>
          ...
          {recentUpdates[0] && (
            ...
            >
              ...
              <div className="p-3">
                ...
                <h3 className="font-bold text-gray-900 mt-1 line-clamp-2 group-hover:text-blue-600 transition-colors">
            ...
            {recentUpdates.slice(1).map((post) => (
              ...
              >
                ...
                <div className="flex-1">
                  <h4 className="text-sm md:text-base font-semibold text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-2">
