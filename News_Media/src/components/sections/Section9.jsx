...
export default function Section9({ articles }) {
  ...
  const trendingArticles = articles?.slice(160, 164) || []; // 2 rows x 4 columns
  ...
  return (
    <section className="w-full bg-gray-50 py-16">
      <div className="max-w-[1450px] mx-auto px-[2rem]">
        {/* Section Title */}
        <h2 className="text-3xl font-extrabold text-gray-900 border-l-4 border-[#ff6700] pl-3 mb-12">
          Trending Articles
        </h2>
