...
export default function Section8({ articles }) {
  ...
  return (
    <section className="w-full bg-gray-50 border-t border-b border-gray-300 py-16">
      <div
        className="max-w-[1450px] mx-auto px-[2rem] flex flex-col lg:flex-row gap-10"
      >
        {/* Left Image */}
        <div
        ...
        <div className="lg:w-1/2 flex flex-col justify-center">
          {featured1.category && (
            <span className="inline-block w-fit bg-[#ff6700] text-white text-xs font-semibold px-4 py-1 rounded-full uppercase mb-4">
