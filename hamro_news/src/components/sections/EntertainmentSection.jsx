// src/components/sections/EntertainmentSection.jsx
...
const EntertainmentSection = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                ...
                if (data.articles && data.articles.length > 80) {
                    setArticles(data.articles.slice(80, 86)); // slice for Entertainment section
                }
            } catch (err) {
    ...
    if (!articles.length) return <p className="text-center py-10">No entertainment news found</p>;
    ...
    return (
        <div className="w-full max-w-[58.125rem] mx-auto px-2 lg:px-0 mt-6 border-b border-gray-300 pb-4">
            <h1 className="text-[1.344rem] text-gray-900 font-semibold mb-4">
                ENTERTAINMENT <span className="text-gray-400">▸</span>
            </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2">
                    <div className="w-full">
                        <div className="overflow-hidden rounded-md group cursor-pointer" onClick={() => handleClick(mainArticle)}>
                            <img
