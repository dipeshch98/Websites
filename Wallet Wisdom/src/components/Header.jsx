  ...
  return (
    <nav className="bg-black text-white shadow-md fixed w-full z-50 ">
      <div className="w-full px-4 sm:px-6 lg:px-8 ">
        <div className="max-w-[1200px] mx-auto flex justify-between items-center h-16 border-b border-white">

          {/* Logo */}
          <Link to="/" className="text-3xl font-extrabold tracking-wide uppercase">
            Wallet<span className="text-yellow-400">Wisdom</span>
          </Link>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-black w-full px-4 pb-4 space-y-2">
